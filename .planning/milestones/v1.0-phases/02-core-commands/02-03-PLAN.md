...
must_haves:
  ...
  key_links:
    ...
    - from: "src/openclawpack/cli.py"
      to: "src/openclawpack/commands/plan_phase.py"
      via: "CLI plan-phase command lazily imports and calls plan_phase_workflow()"
      pattern: "from openclawpack\\.commands\\.plan_phase import plan_phase_workflow"
    - from: "src/openclawpack/cli.py"
      to: "src/openclawpack/commands/execute_phase.py"
      via: "CLI execute-phase command lazily imports and calls execute_phase_workflow()"
      pattern: "from openclawpack\\.commands\\.execute_phase import execute_phase_workflow"
---
...
6. Verify cli.py wiring: `python -c "from openclawpack.commands.plan_phase import plan_phase_workflow; from openclawpack.commands.execute_phase import execute_phase_workflow"` — imports succeed, confirming CLI dispatch paths are valid
</verification>
