...
must_haves:
  truths:
    ...
    - "Concurrent stdout/stderr reading is handled by the SDK without manual pipe management"
...
<task type="auto">
  ...
  <action>
    ...
    **tests/test_transport/test_client.py:**
    ...
    - Note: Do NOT test actual SDK calls (requires Claude Code installed and authenticated). Those are integration tests for later. Focus on unit testing the adapter's construction, config handling, and lazy import behavior.
  </action>
  <verify>
